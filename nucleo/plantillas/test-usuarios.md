...
# Investigación con usuarios — <tema>
...
## Guion de sesión
<!-- Bienvenida (no evaluamos a la persona, evaluamos el diseño), tareas una por una pensando en voz alta, preguntas de cierre. Prohibido guiar o defender el diseño durante la sesión. -->

## Resultados por participante
| # | Perfil | Tarea | Resultado (completó / con dificultad / abandonó) | Observación clave | Evidencia |
|---|---|---|---|---|---|

## Hallazgos derivados
<!-- Cada patrón observado en 2+ participantes se convierte en hallazgo estándar (plantilla hallazgo.md) con este archivo como evidencia. Lo que dijo UN participante es señal, no hallazgo. -->
